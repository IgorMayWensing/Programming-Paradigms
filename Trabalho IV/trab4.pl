...
solucao(ListaSolucao) :-
    ...
    ListaSolucao = [
        mae(Vestido1, Nomedamae1, Filho1, Idade1, Comida1, Estado1),
        mae(Vestido2, Nomedamae2, Filho2, Idade2, Comida2, Estado2),
        mae(Vestido3, Nomedamae3, Filho3, Idade3, Comida3, Estado3),
        mae(Vestido4, Nomedamae4, Filho4, Idade4, Comida4, Estado4),
        mae(Vestido5, Nomedamae5, Filho5, Idade5, Comida5, Estado5)
    ],

    %luiz esta na terceira pocisão
    Filho3 =luiz,
    ...
    %A mae de Francisco está exatamente à esquerda da mae de Luiz.
    aEsquerda(mae(_,_,francisco,_,_,_), mae(_,_,luiz,_,_,_), ListaSolucao),
    aoLado(mae(_,_,francisco,_,_,_), mae(_,_,luiz,_,_,_), ListaSolucao),
    ...
    nomedamae(Nomedamae1),
    nomedamae(Nomedamae2),
    nomedamae(Nomedamae3),
    nomedamae(Nomedamae4),
    nomedamae(Nomedamae5),
    todosDiferentes([Nomedamae1, Nomedamae2, Nomedamae3, Nomedamae4, Nomedamae5]),
